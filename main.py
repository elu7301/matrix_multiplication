...
if __name__ == '__main__':
    ...
    A = np.random.randint(0, 10, size=(a, b)).tolist()  # Преобразуем в список
    B = np.random.randint(0, 10, size=(c, d)).tolist()  # Преобразуем в список
    ...
    try:
        ...
        # Выводим результат
        print("Matrix A:")
        print(np.array(A))  # Преобразуем обратно в NumPy массив для вывода
        print("\nMatrix B:")
        print(np.array(B))  # Преобразуем обратно в NumPy массив для вывода
        print("\nResult:")
        print(result)
